			...
			u = {
				...
				_modalConent: function() {
					var n = t._classes.title,
						...
						a = t.buttonText,
						f = ["alert", "prompt"], //f = ["alert", "confirm", "prompt"],
				...
				_position: function() {
					...
					if (t.center) {
						n = {
							top: e(window).height() < e(s).height() ? 1 : 40,
							left: 50,
							marginTop: e(window).height() < e(s).height() ? 0 : -e(s).height() / 2,
							marginLeft: -e(s).width() / 2
						}, r = {
						...
						n = {
							top: e(window).height() < e(s).height() ? 1 : 10,
							left: 50,
							marginTop: 0,
							marginLeft: -e(s).width() / 2
						}, r = {
