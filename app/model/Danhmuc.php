...
{		
	...
	public static function action_ds()
	{
		...
		$db = new Sanpham_model();
		$param['sanphams']=$db->get_sanpham_byctgno($param['acw_url'][0],100);
	...
	public function get_catgory_all($all_flg= FALSE)
	{
		$sql = "select * from(
	...
	public function get_category_rows()
	{
